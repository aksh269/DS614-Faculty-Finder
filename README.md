...
The following statistics compare the raw scraped dataset, the cleaned transformed dataset, and the final SQLite database. These metrics validate data quality improvements, schema consistency, and successful persistence across the pipeline.

| Metric / Stage               | Raw Data (CSV) | Cleaned Data (CSV) | Database (SQLite) |
|-----------------------------|---------------|--------------------|-------------------|
| Total Records               | 106           | 106                | 106               |
| Missing PhD Field           | 2             | 2                  | 2                 |
| Missing Email IDs           | 1             | 1                  | 1                 |
| Missing Biography           | 39            | 39                 | 39                |
| Missing Specialization      | 2             | 0                  | 0                 |
| Missing Research Field      | 96            | 0                  | 0                 |
| Missing Publications        | 49            | 49                 | 49                |
| Duplicate Faculty IDs       | N/A           | 0                  | 0                 |
| HTML / Noisy Text Present   | Yes           | Removed            | Removed           |
| Combined Text Field         | Not Available | Generated (100%)   | Stored (100%)     |
| Records Successfully Stored | N/A           | N/A                | 106               |

These statistics confirm that the transformation pipeline successfully standardizes and enriches the data while preserving genuine missing information, and that the final SQLite database accurately reflects the cleaned dataset without data loss or duplication.
